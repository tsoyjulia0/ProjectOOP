...
public class Test {
	...
	public static void main(String[] args) {
		...
		TeacherModel t5 = new TeacherModel(5,"T2205", "pass5", "Akerke", "Nasyr", Gender.M, TeachDegree.T);
...
//		StudentModel s1=new StudentModel("a_alenov@kbtu.kz","jsjsjd","Abay",Gender.M);
//	    StudentModel s2=new StudentModel("y_tsoy@kbtu.kz","aazzz","Yuliya",Gender.F);
//	    StudentModel s3=new StudentModel("d_dauren@kbtu.kz","fxxxz","Dauren",Gender.F);
//	    StudentModel s4=new StudentModel("t_tempo@kbtu.kz","asdsw","Tempo",Gender.F);
//	    StudentModel s5=new StudentModel("asd_sdawe@kbtu.kz","vxcvcer","ASRQWS",Gender.M);
//	    StudentModel s6=new StudentModel("fsf_asdasx@kbtu.kz","wetsgs","FVVd",Gender.M);
//	    StudentModel s7=new StudentModel("aeqwed__sdmar@kbtu.kz","bbbcxd","Madi",Gender.M);
//	    StudentModel s8=new StudentModel("aweiifj_fjaf@kbtu.kz","sdasweq","Damir",Gender.F);
//	    StudentModel s9=new StudentModel("fmrjr_asd@kbtu.kz","wqgsv","Mariya",Gender.F);
//	    StudentModel s10=new StudentModel("dac_qwee@kbtu.kz","fffsa","Hyi",Gender.M);
	    
		StudentModel s1=new StudentModel(21030751,"a_alenov@kbtu.kz","jsjsjd","Abay","Alenov",Gender.M, 4); 
	    StudentModel s2=new StudentModel(21876575,"y_tsoy@kbtu.kz","aazzz","Юля","Tsoi",Gender.F, 1); 
		...
		Course cr1 = new Course(c1, t1, students );
		Course cr2 = new Course(c2, t2, students);
		Course cr3 = new Course(c3, t4, students);
		Course cr4 = new Course(c4, t9, students);
		...
		ac.removeStudent(s31);
		System.out.println(db.getStudents(m1));
		
		
//		tc1.putMark(s11, 30, "1Att");
//		st11.viewMarks();
